...
<section class="detail-content">
    <div class="sn-nav sn-block">
        <div class="sn-nav-back"><a data-name="prodDetail_none_main_back" class="sn-iconbtn"
    ...
    <section>
            ...
            <div class="pic-slider lazyimg" style="visibility: visible;">
                <ul style="width: 3750px;">
                    <li class="item" data-index="0"
                        style="width: 750px; left: 0px; transition-duration: 0ms; -webkit-transition-duration: 0ms; -webkit-transform: translate(0px, 0px) translateZ(0px);">
        ...
        <div class="intro cm-pd-white">
            <div class="intro-price">
                <div id="priceInfo" style="float:left;width:49%; ">
                    <span class="price-a" id="proprice">${product.money} 元</span>
                </div>
                <div class="shopping-car-fun" style="float:right;width:49%; ">
                    <a data-name="prodDetail_none_main_buy" id="buyNow" href="user/cart?pid=${product.id}"
                       style="-webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">立即购买</a>
                </div>
            </div>
            <br />
        ...
        <div>
            <div class="sn-tab-content wbox" style="width: 300%; -webkit-transform: translateX(0px);">
                <div class="desc-spec sn-tab-box wbox-flex" style="height: auto;">
                    ...
                    <div class="desc-spec-sale desc-spec-item"
