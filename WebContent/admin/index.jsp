...
<head>
    ...
    <title>三级分销系统后台</title>
    <meta name="Keywords" content="三级分销分销系统"/>
    <meta name="Description" content="三级分销分销系统后台"/>
    <!-- bootstrap - css -->
...
<header class="navbar navbar-default" id="bjui-header">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="" target="_blank"><img
                src="../res/images/hansanlogo.png"></a>
    </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">我的账户 <span
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="changePwd" data-toggle="dialog" data-id="changepwd_page" data-mask="true"
                           data-width="400" data-height="260">&nbsp;
    ...
    <div id="bjui-sidebar-s">
        <div class="collapse">
            <div class="toggleCollapse">
                <div title="展开菜单"><i class="fa fa-angle-double-right"></i></div>
            </div>
        </div>
    </div>
    <div id="bjui-sidebar">
        <div class="toggleCollapse"><h2>主菜单</h2>
            <div title="收缩菜单"><i class="fa fa-angle-double-left"></i></div>
        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelContent">
                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#bjui-accordionmenu"
                                               href="#bjui-collapse0" class="active">
                ...
                <div id="bjui-collapse0" class="panel-collapse panelContent collapse in">
                    <div class="panel-body">
                        <ul id="bjui-tree0" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick"
                            ...
                            <li data-id="11" data-pid="1" data-url="articleCateList" data-tabid="articleCateList">文章栏目
                            </li>
                            <li data-id="12" data-pid="1" data-url="articleList" data-tabid="articleList">文章管理</li>
                            <li data-id="12" data-pid="1" data-url="productCateList" data-tabid="productCateList">产品分类
                            </li>
                            ...
                            <li data-id="15" data-pid="1" data-url="commissionList" data-tabid="commissionList">佣金明细
                            </li>
                            ...
                            <li data-id="15" data-pid="1" data-url="rechargeCardList" data-tabid="rechargeCardList">
                                充值卡管理
                            </li>
                        </ul>
                    </div>
        ...
        <div class="tabsPageHeader">
            <div class="tabsPageHeaderContent">
                <ul class="navtab-tab nav nav-tabs">
                    <li data-tabid="main" class="main active"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a>
                    </li>
                </ul>
            </div>
                ...
                <div class="bjui-pageHeader" style="background:#FFF;">
                    <div style="padding: 0 5px;">
                        ...
                        <div class="row alert alert-success" style="margin: 10px 10px 10px 10px;">
                            <h4 style="margin-bottom:20px;">欢迎使用三级分销微商城程序&nbsp;<small></small>
                            </h4>
                            <div class="col-md-6">
                                <h5>三级分销分销系统</h5>
                            </div>
                            <div class="col-md-6">
                                <h5>TEL：18928742919</h5>
                                <h5>三级分销：<a href="" target="_blank"></a>
                                </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bjui-pageContent">
                    <div style="margin-top:5px; margin-right:10px;">
                        <div class="row" style="padding: 0 8px;">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">当前版本：<code>VERSION2.3</code></h3>
                                    </div>
                                    <div class="panel-body bjui-doc" style="padding:0;">
                                        <div class="col-md-6">
                                            <h5>服务器操作系统：<%=props.getProperty("os.name") %>
                                            </h5>
                                            <h5>服务器CPU：<%=r.availableProcessors() %>核</h5>
                                            <h5>本地IP地址：<%=ip %>
                                            </h5>
                                            <h5>本地主机名：<%=addr.getHostName() %>
                                            </h5>
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Java版本：<%=props.getProperty("java.version") %>
                                            </h5>
                                            <h5>Java安装路径：<%=props.getProperty("java.home") %>
                                            </h5>
                                            <h5>用户主目录：<%=props.getProperty("user.home") %>
                                            </h5>
                                            <h5>JVM总内存：<%=r.totalMemory() / 1024L / 1024L %>M</h5>
                                            <h5>JVM剩余内存：<%=r.freeMemory() / 1024L / 1024L %>M</h5>
                                            <h5>JVM CPU个数：<%=r.availableProcessors() %>
                                            </h5>
...
<footer id="bjui-footer">Copyright &copy; 2017 -
