    ...
    <c:if test="${requestScope.status==1 }">
        <div class="input-a sn-block wbox mt30 pr">
            ...
            <div class="wbox-flex ml30 pr">
                <input type="text" id="no" name="user.no" value="" placeholder="请刷新生成编号" maxlength="6"
                       readonly="readonly">
            </div>
        ...
        <div class="input-a sn-block wbox mt30 pr">
            <span>联系人</span>
            <div class="wbox-flex ml30 pr">
                <input type="text" id="contacts" name="user.contacts" value="" placeholder="请输入联系人" maxlength="32">
            </div>
            <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
        </div>
        <div class="input-a sn-block wbox mt30 pr">
            <span>收货地址</span>
            <div class="wbox-flex ml30 pr">
                <input type="text" id="address" name="user.address" value="" placeholder="请输入收货地址" maxlength="32">
            </div>
            <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
        </div>
        <div class="input-a sn-block wbox mt30 pr">
            <span>邮编</span>
            <div class="wbox-flex ml30 pr">
                <input type="text" id="post" name="user.post" value="" placeholder="请输入邮编" maxlength="32">
            </div>
            <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
        </div>
        <div class="input-a sn-block wbox mt30 pr">
            <span>推荐人</span>
            <div class="wbox-flex ml30 pr">
                <input type="text" id="tuijianren" name="tuijianren" value="${requestScope.no }" placeholder="请输入推荐人编号"
                       readonly="readonly" maxlength="32">
            </div>
            <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
        </div>
        <a href="javascript:void(0)" id="nextStep" name="Wap_reg_person_005" onclick="register();return false;"
