...
<section class="sn-main pr">
    ...
    <div class="input-a sn-block wbox mt30 pr">
        <span>确认新密码</span>
        <div class="wbox-flex ml30 pr">
            <input type="password" id="renewPassword" name="renewPassword" value="" placeholder="请重新输入新密码"
                   maxlength="32">
        </div>
        <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
    </div>
    <div class="input-a sn-block wbox mt30 pr">
        <span>联系人</span>
        <div class="wbox-flex ml30 pr">
            <input type="text" id="contacts" name="contacts" value="" placeholder="请输入联系人" maxlength="32">
        </div>
        <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
    </div>
    <div class="input-a sn-block wbox mt30 pr">
        <span>收货地址</span>
        <div class="wbox-flex ml30 pr">
            <input type="text" id="address" name="address" value="" placeholder="请输入收货地址" maxlength="32">
        </div>
        <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
    </div>
    <div class="input-a sn-block wbox mt30 pr">
        <span>邮编</span>
        <div class="wbox-flex ml30 pr">
            <input type="text" id="post" name="post" value="" placeholder="请输入邮编" maxlength="32">
        </div>
        <em class="delete" style="display:none" name="Wap_reg_person_001"></em>
    </div>
    <a href="javascript:void(0)" id="nextStep" name="Wap_reg_person_005" onclick="changePassword();return false;"
       class="first-step sn-btn sn-btn-big sn-btn-block m30 sn-btn-positive">修改</a>
</section>
