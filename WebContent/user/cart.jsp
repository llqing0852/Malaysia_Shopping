...
<head>
    ...
    <script type="text/javascript">
        ...
        function ordersSave() {
            ...
            if (userName == "") {
                alertDefaultStyle("mini", "请输入持卡人姓名");
            } else if (cardNo == "") {
                alertDefaultStyle("mini", "请输入信用卡卡号");
            }
            else {
                window.location.href = "ordersSave?pid=" + pid + "&num=" + number + "&userName=" + userName + "&cardNo=" + cardNo;
            }
        }
...
<section class="ww" style="min-height:11rem;">
                                ...
                                <div class="pr">
                                        ...
                                        <div class="pro-box">
                                            ...
                                            <div class="sn-count">
                                                <a href="javascript:void(0);" class="count-min "
                                                   onclick="updateQuantity(-1);"></a>
                                                <input type="text" value="1" class="input-reset count-num" maxlength="3"
                                                       id="quantity" onblur="updateQuantityOnblur()"/>
                                    ...
                                    <div class="cart-list-opra wbox">
                                        <div class="wbox-flex tr">
                                            <p class="fs26 sn-txt-assertive ofv ">
                                                &yen;${requestScope.product.money }</p>
                                        </div>
                                    ...
                                    <div class="wbox ">
                                        ...
                                        <div class="pro-box">
                                            <input type="text" id="userName" name="userName" value=""
                                                   placeholder="请输入持卡人姓名" maxlength="8"><br/><br/>
                                            <input type="text" id="cardNo" name="cardNo" value=""
                                                   placeholder="请输入信用卡卡号" maxlength="21">
                                        </div>
                                    </div>
                                </div>
                                <div class="cart-active sn-txt-assertive wbox" id="error_message_0"></div>
    ...
    <div class="cart-fixed" style="bottom: 9%;">
        <div class="wbox pd">
            <div class="wbox-flex sn-txt-muted">
                <div class="fs30">
                    合计:
                    <i class="sn-txt-assertive">&yen;<span
                            id="userPayAllPrice">${requestScope.product.money }</span></i>
                </div>
            </div>
