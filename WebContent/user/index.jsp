        ...
        <ul class="sn-list-input">
            ...
            <li>
                <a href="../list.jsp" class="block wbox">
                    <label class="meb-list-ico"
                           style="background:url('../images/ico-myDate.png') no-repeat left center;background-size:1rem 1rem;">我要购买</label>
            ...
            <li>
                <a href="ordersList.jsp" class="block wbox" id="mts-allorder">
                    <label class="meb-list-ico"
                           style="background:url('../images/or.png') no-repeat left center;background-size:1rem 1rem;">订单管理</label>
        ...
        <ul class="sn-list-input">
            ...
            <c:if test="${config.onlinePayIsOpen==1 }">
                <li>
                    <a href="recharge.jsp" class="block wbox">
                        <label class="meb-list-ico"
                               style="background:url('../images/143385213411317884.jpg') no-repeat left center;background-size:1rem 1rem;">在线充值</label>
                        <div class="wbox-flex tr sn-txt-muted arrow">
                        </div>
                    </a>
                </li>
            ...
            <c:if test="${config.rechargeCardIsOpen==1 }">
                <li>
                    <a href="rechargeCard.jsp" class="block wbox">
                        <label class="meb-list-ico"
                               style="background:url('../images/ico-sales.png') no-repeat left center;background-size:1rem 1rem;">充值卡充值</label>
                        <div class="wbox-flex tr sn-txt-muted arrow">
                        </div>
                    </a>
                </li>
            ...
            <li>
                <a href="commissionToBalance.jsp" class="block wbox">
                    <label class="meb-list-ico"
                           style="background:url('../images/ico-mylqb.png') no-repeat left center;background-size:1rem 1rem;">奖金转入</label>
                    <div class="wbox-flex tr sn-txt-muted arrow">
                    </div>
                </a>
            </li>
            <li>
                <a href="balanceToUser.jsp" class="block wbox">
                    <label class="meb-list-ico"
                           style="background:url('../images/ico-myDate.png') no-repeat left center;background-size:1rem 1rem;">会员转账</label>
                    <div class="wbox-flex tr sn-txt-muted arrow">
                    </div>
                </a>
            </li>
