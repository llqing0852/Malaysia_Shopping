...
<section class="ww order-wrap">
    ...
    <div class="order-tab" id="b2cOrder"
        ...
        <ul class="order-nav wwbox" id="orderTab">
            <li class="cur" id="orderTab0"><a href="javascript:void(0);" onclick="javascript:change(-1);">全部订单</a></li>
            <%--<li class="" id="orderTab2"><a href="javascript:void(0);" onclick="javascript:change(0);">待支付</a></li>--%>
            <li class="" id="orderTab6"><a href="javascript:void(0);" onclick="javascript:change(6);">待收货</a></li>
            <li class="" id="orderTab1"><a href="javascript:void(0);" onclick="javascript:change(1);">已完成</a></li>
        </ul>
        ...
        <script>
            ...
            function change(t) {
                if (t == -1) {
                    $("#orderTab0").removeClass().addClass("cur");
                    $("#orderTab1").removeClass();
                    $("#orderTab6").removeClass();
                } else if (t == 1) {
                    $("#orderTab0").removeClass();
                    $("#orderTab1").removeClass().addClass("cur");
                    $("#orderTab6").removeClass();
                } else {
                    $("#orderTab0").removeClass();
                    $("#orderTab1").removeClass();
                    $("#orderTab6").removeClass().addClass("cur");
                }
                page = 1;
                type = t;
                $("#orderList").empty();
