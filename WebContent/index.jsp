        ...
        <div class="app06 floor-area" id="navCarousel_box">
            <ul class="fix">
                <li><a name="index_none_floor3_330052" href="user/index.jsp">
                    <img alt="" data-src="done" src="images/143262193526726791.jpg">
                    <div class="title">会员中心</div>
                </a></li>
                <li><a name="index_none_floor3_330051" href="user/promote.jsp">
                    <img alt="" data-src="done" src="images/143262190460206422.jpg">
                    <div class="title">推广链接</div>
                </a></li>
                <li><a name="index_none_floor3_330053" href="user/ordersList.jsp"><img alt="" data-src="done"
                                                                                       src="images/143262692801385199.jpg">
