...
<section class="sn-main pr">
    ...
    <a href="javascript:void(0)" id="nextStep" name="Wap_reg_person_005" onclick="login();return false;"
       class="first-step sn-btn sn-btn-big sn-btn-block m30 sn-btn-positive">登录</a>
